...
.method public declared-synchronized releaseConnection(Lorg/apache/http/conn/ManagedClientConnection;JLjava/util/concurrent/TimeUnit;)V
    ...
    .line 260
    instance-of v5, p1, Lorg/apache/http/impl/conn/SingleClientConnManager$ConnAdapter;
    ...
    const-string v6, "Connection class mismatch, connection not obtained from this manager."
    ...
    .line 271
    .local v4, "sca":Lorg/apache/http/impl/conn/SingleClientConnManager$ConnAdapter;
    iget-object v5, v4, Lorg/apache/http/impl/conn/SingleClientConnManager$ConnAdapter;->poolEntry:Lorg/apache/http/impl/conn/AbstractPoolEntry;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_2
    :try_start_2
    invoke-virtual {v4}, Lorg/apache/http/impl/conn/SingleClientConnManager$ConnAdapter;->getManager()Lorg/apache/http/conn/ClientConnectionManager;
    ...
    const-string v6, "Connection not obtained from this manager."
    ...
    :cond_3
    :try_start_3
    invoke-virtual {v4}, Lorg/apache/http/impl/conn/SingleClientConnManager$ConnAdapter;->isOpen()Z
    ...
    invoke-virtual {v4}, Lorg/apache/http/impl/conn/SingleClientConnManager$ConnAdapter;->isMarkedReusable()Z
    ...
    .line 292
    :cond_5
    invoke-virtual {v4}, Lorg/apache/http/impl/conn/SingleClientConnManager$ConnAdapter;->shutdown()V
    :try_end_3
    ...
    :cond_6
    :try_start_4
    invoke-virtual {v4}, Lorg/apache/http/impl/conn/SingleClientConnManager$ConnAdapter;->detach()V
    ...
    const-string v6, "Exception shutting down released connection."
