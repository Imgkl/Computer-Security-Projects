...
.method private createDigestHeader(Lorg/apache/http/auth/Credentials;)Lorg/apache/http/Header;
    ...
    .line 261
    new-instance v33, Lorg/apache/http/auth/AuthenticationException;
    ...
    invoke-direct/range {v33 .. v34}, Lorg/apache/http/auth/AuthenticationException;-><init>(Ljava/lang/String;)V
    ...
    invoke-static/range {v33 .. v33}, Lorg/apache/http/impl/auth/DigestScheme;->encode([B)Ljava/lang/String;
    ...
    .line 368
    .local v23, "params":Ljava/util/List;, "Ljava/util/List<Lorg/apache/http/message/BasicNameValuePair;>;"
    ...
    check-cast v22, Lorg/apache/http/message/BasicNameValuePair;

    .line 388
    .local v22, "param":Lorg/apache/http/message/BasicNameValuePair;
    if-lez v16, :cond_e
    ...
    invoke-virtual/range {v22 .. v22}, Lorg/apache/http/message/BasicNameValuePair;->getName()Ljava/lang/String;
    ...
    :goto_8
    sget-object v34, Lorg/apache/http/message/BasicHeaderValueFormatter;->DEFAULT:Lorg/apache/http/message/BasicHeaderValueFormatter;
    ...
    .end local v22    # "param":Lorg/apache/http/message/BasicNameValuePair;
    .end local v23    # "params":Ljava/util/List;, "Ljava/util/List<Lorg/apache/http/message/BasicNameValuePair;>;"
    ...
    .line 283
    .local v12, "ex":Lorg/apache/http/impl/auth/UnsupportedDigestAlgorithmException;
    new-instance v33, Lorg/apache/http/auth/AuthenticationException;
    ...
    .line 292
    .end local v12    # "ex":Lorg/apache/http/impl/auth/UnsupportedDigestAlgorithmException;
    ...
    .line 375
    .restart local v23    # "params":Ljava/util/List;, "Ljava/util/List<Lorg/apache/http/message/BasicNameValuePair;>;"
    :cond_17
    const-string v33, "auth"
    ...
    .restart local v22    # "param":Lorg/apache/http/message/BasicNameValuePair;
    :cond_18
    const/16 v19, 0x0
    ...
    .end local v22    # "param":Lorg/apache/http/message/BasicNameValuePair;
    :cond_1a
    new-instance v33, Lorg/apache/http/message/BufferedHeader;
