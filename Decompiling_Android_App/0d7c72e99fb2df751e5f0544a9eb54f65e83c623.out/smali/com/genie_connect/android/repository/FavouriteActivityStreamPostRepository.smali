.class public Lcom/genie_connect/android/repository/FavouriteActivityStreamPostRepository;
.super Lcom/genie_connect/android/repository/base/BaseRepository;
.source "FavouriteActivityStreamPostRepository.java"
...
.method public constructor <init>(Lde/greenrobot/dao/Dao;Landroid/content/Context;Lcom/genie_connect/android/db/datastore/acl/Acl;Lcom/genie_connect/android/repository/NoteRepository;)V
    ...
    .prologue
    .line 63
    .local p1, "dao":Lde/greenrobot/dao/Dao;, "Lde/greenrobot/dao/Dao<Lcom/genie_connect/common/db/model/FavouriteActivityStreamPost;Ljava/lang/Long;>;"
...
# virtual methods
.method public getFavouritedPostIds()Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 74
    invoke-virtual {p0}, Lcom/genie_connect/android/repository/FavouriteActivityStreamPostRepository;->query()Lde/greenrobot/dao/query/QueryBuilder;

    move-result-object v0

    sget-object v1, Lcom/genie_connect/common/db/model/FavouriteActivityStreamPost$Properties;->ActivityStreamPost:Lde/greenrobot/dao/Property;

    invoke-virtual {v0, v1}, Lde/greenrobot/dao/query/QueryBuilder;->listOfFieldAsLong(Lde/greenrobot/dao/Property;)Ljava/util/List;
...
.method public getLinkField(Lcom/genie_connect/common/db/entityfactory/GenieEntity;)Ljava/lang/String;
    ...
    .prologue
    .line 79
    const-string v0, "activityStreamPost"
...
.method public isFavourited(Ljava/lang/Long;)Z
    .locals 3
    .param p1, "asPostId"    # Ljava/lang/Long;
