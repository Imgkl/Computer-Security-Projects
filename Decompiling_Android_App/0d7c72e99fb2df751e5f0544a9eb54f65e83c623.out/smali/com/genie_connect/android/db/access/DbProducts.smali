.class public final Lcom/genie_connect/android/db/access/DbProducts;
.super Lcom/genie_connect/android/db/access/BaseDb;
.source "DbProducts.java"
...
.field private final SQL_SELECT_DETAIL:[Ljava/lang/String;

.field private final SQL_SELECT_SUMMARY:[Ljava/lang/String;

.field private final SQL_SELECT_SUMMARY_NO_JOINS:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lcom/genie_connect/android/db/access/GenieConnectDatabase;)V
    ...
    .line 56
    invoke-virtual {p0}, Lcom/genie_connect/android/db/access/DbProducts;->getPrimaryEntity()Lcom/genie_connect/common/db/entityfactory/GenieEntity;
    ...
    iput-object v0, p0, Lcom/genie_connect/android/db/access/DbProducts;->ENTITY_NAME:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/genie_connect/android/db/access/DbProducts;->ENTITY_NAME:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/genie_connect/android/db/access/DbProducts;->ENTITY_NAME_DOT:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/genie_connect/android/db/access/DbProducts;->ENTITY_NAME_DOT:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/genie_connect/android/db/access/DbProducts;->ENTITY_NAME_DOT:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/genie_connect/android/db/access/DbProducts;->SQL_SELECT_SUMMARY_NO_JOINS:[Ljava/lang/String;
    ...
    const-string v2, "exhibitors.name"

    const-string v3, "exhibitorName"

    invoke-static {v2, v3}, Lcom/genie_connect/android/db/access/DbProducts;->alias(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "f.product IS NOT NULL"
    ...
    const-string v2, "n.relatedProduct IS NOT NULL"

    const-string v3, "hasNote"
    ...
    iput-object v0, p0, Lcom/genie_connect/android/db/access/DbProducts;->SQL_SELECT_SUMMARY:[Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/genie_connect/android/db/access/DbProducts;->SQL_SELECT_DETAIL:[Ljava/lang/String;
...
.method private search(Ljava/lang/String;Lcom/genie_connect/android/net/container/gson/objects/TreeNodeGsonModel;I)Luk/co/alt236/easycursor/EasyCursor;
    ...
    iget-object v4, p0, Lcom/genie_connect/android/db/access/DbProducts;->ENTITY_NAME:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/genie_connect/android/db/access/DbProducts;->ENTITY_NAME_DOT:Ljava/lang/String;
    ...
    invoke-static {v4, v5}, Lcom/genie_connect/android/db/access/DbProducts;->alias(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 343
    const-string v4, "f.product IS NOT NULL"
    ...
    .line 344
    const-string v4, "n.relatedProduct IS NOT NULL"
    ...
    const-string v5, "LEFT OUTER JOIN exhibitors ON "
    ...
    const-string v5, "LEFT OUTER JOIN favouriteproducts f ON products.id = f.product "
    ...
    invoke-virtual {p0, v5}, Lcom/genie_connect/android/db/access/DbProducts;->getEventFavCriteriaSQL(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v5, "LEFT OUTER JOIN notes n ON products.id = n.relatedProduct "
    ...
    invoke-virtual {p0, v5}, Lcom/genie_connect/android/db/access/DbProducts;->getEventNoteCriteriaSQL(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 352
    const-string v4, "LEFT OUTER JOIN products_relatedTags d ON products.id = d.products_id "
    ...
    invoke-static {}, Lcom/genie_connect/android/db/access/DbProducts;->getStringCollation()Ljava/lang/String;
    ...
    .line 360
    const-string v4, "products.name like ? OR products.fullDescription like ? OR products.customField1 like ? OR products.customField2 like ? OR products.customField3 like ? OR products.customField4 like ? OR products.customField5 like ?"
    ...
    invoke-virtual {p0}, Lcom/genie_connect/android/db/access/DbProducts;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method public getAll()Luk/co/alt236/easycursor/EasyCursor;
    ...
    invoke-virtual {p0, v1, v1, v0}, Lcom/genie_connect/android/db/access/DbProducts;->getProducts(Ljava/lang/Long;Ljava/lang/Long;Z)Luk/co/alt236/easycursor/EasyCursor;
...
.method public getById(J)Luk/co/alt236/easycursor/EasyCursor;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/genie_connect/android/db/access/DbProducts;->getProducts(Ljava/lang/Long;Ljava/lang/Long;Z)Luk/co/alt236/easycursor/EasyCursor;
...
.method public getProductImagesUrl(J)Luk/co/alt236/easycursor/EasyCursor;
    .locals 9
    .param p1, "productId"    # J
    ...
    .line 140
    const-string v7, "products_imagesUrl"
    ...
    const-string v2, "products_imagesUrl"
...
.method public getProducts(Ljava/lang/Long;Ljava/lang/Long;Z)Luk/co/alt236/easycursor/EasyCursor;
    .locals 10
    .param p1, "productId"    # Ljava/lang/Long;
    .param p2, "tagFilter"    # Ljava/lang/Long;
    .param p3, "favorite"    # Z
    ...
    iget-object v1, p0, Lcom/genie_connect/android/db/access/DbProducts;->SQL_SELECT_SUMMARY:[Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/genie_connect/android/db/access/DbProducts;->ENTITY_NAME_DOT:Ljava/lang/String;

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, "exhibitor"
    ...
    const-string v9, "exhibitors.id"

    invoke-static {v5, v8, v9}, Lcom/genie_connect/android/db/access/DbProducts;->leftOuterJoin(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v5, " LEFT OUTER JOIN products_relatedtags c ON (products.id = c.products_id)"
    ...
    .end local v7    # "sqlTables":Ljava/lang/String;
    :cond_3
    iget-object v1, p0, Lcom/genie_connect/android/db/access/DbProducts;->SQL_SELECT_DETAIL:[Ljava/lang/String;

    goto/16 :goto_0
.end method

.method public getProductsByIds(Ljava/util/ArrayList;)Luk/co/alt236/easycursor/EasyCursor;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 216
    iget-object v1, p0, Lcom/genie_connect/android/db/access/DbProducts;->SQL_SELECT_SUMMARY_NO_JOINS:[Ljava/lang/String;
...
.method public getProductsForExhibitor(J)Luk/co/alt236/easycursor/EasyCursor;
    .locals 19
    ...
    iget-object v3, v0, Lcom/genie_connect/android/db/access/DbProducts;->SQL_SELECT_SUMMARY:[Ljava/lang/String;

    .line 248
    .local v3, "sqlSelect":[Ljava/lang/String;
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    iget-object v6, v0, Lcom/genie_connect/android/db/access/DbProducts;->ENTITY_NAME_DOT:Ljava/lang/String;

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, "exhibitor"
    ...
    invoke-static {v4, v5, v6}, Lcom/genie_connect/android/db/access/DbProducts;->leftOuterJoin(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, " LEFT OUTER JOIN favouriteproducts f ON (products.id = f.product "
    ...
    invoke-virtual {v0, v4}, Lcom/genie_connect/android/db/access/DbProducts;->getEventFavCriteriaSQL(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, " LEFT OUTER JOIN notes n ON (products.id = n.relatedProduct "
    ...
    invoke-virtual {v0, v4}, Lcom/genie_connect/android/db/access/DbProducts;->getEventNoteCriteriaSQL(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 263
    .local v7, "sqlWhere":Ljava/lang/String;
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "c.exhibitors="
    ...
    const-string v4, " LEFT OUTER JOIN products_exhibitors c ON (c.products_id = products.id)"
    ...
    .line 266
    const-string v2, "query_products"

    invoke-static {v3}, Lcom/eventgenie/android/utils/help/SetUtils;->convertStringArrayToSet([Ljava/lang/String;)Ljava/util/Set;
    ...
    .line 280
    .local v15, "queryProducts":Ljava/lang/String;
    move-object/from16 v0, v16
    ...
    const-string v4, "products.exhibitor="
    ...
    .line 283
    const-string v2, "query_exhibitor"
    ...
    .line 295
    .local v14, "queryProduct":Ljava/lang/String;
    const/4 v2, 0x2
    ...
    invoke-virtual {v1, v0, v12, v2}, Landroid/database/sqlite/SQLiteQueryBuilder;->buildUnionQuery([Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v13

    .line 301
    .local v13, "q":Ljava/lang/String;
    new-instance v11, Luk/co/alt236/easycursor/sqlcursor/querybuilders/EasyCompatSqlModelBuilder;

    invoke-direct {v11}, Luk/co/alt236/easycursor/sqlcursor/querybuilders/EasyCompatSqlModelBuilder;-><init>()V

    .line 302
    .local v11, "builder":Luk/co/alt236/easycursor/sqlcursor/querybuilders/EasyCompatSqlModelBuilder;
    const/4 v2, 0x0

    invoke-virtual {v11, v13, v2}, Luk/co/alt236/easycursor/sqlcursor/querybuilders/EasyCompatSqlModelBuilder;->setQueryParams(Ljava/lang/String;[Ljava/lang/String;)V

    .line 303
    invoke-virtual {v11}, Luk/co/alt236/easycursor/sqlcursor/querybuilders/EasyCompatSqlModelBuilder;->build()Luk/co/alt236/easycursor/sqlcursor/EasySqlQueryModel;

    move-result-object v2

    invoke-virtual/range {p0 .. p0}, Lcom/genie_connect/android/db/access/DbProducts;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method public search(Ljava/lang/Long;)Luk/co/alt236/easycursor/EasyCursor;
    ...
    invoke-virtual {p0, v0, p1, v1}, Lcom/genie_connect/android/db/access/DbProducts;->getProducts(Ljava/lang/Long;Ljava/lang/Long;Z)Luk/co/alt236/easycursor/EasyCursor;
...
.method public search(Ljava/lang/String;)Luk/co/alt236/easycursor/EasyCursor;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/genie_connect/android/db/access/DbProducts;->search(Ljava/lang/String;Lcom/genie_connect/android/net/container/gson/objects/TreeNodeGsonModel;)Luk/co/alt236/easycursor/EasyCursor;
...
.method public search(Ljava/lang/String;I)Luk/co/alt236/easycursor/EasyCursor;
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/genie_connect/android/db/access/DbProducts;->search(Ljava/lang/String;Lcom/genie_connect/android/net/container/gson/objects/TreeNodeGsonModel;I)Luk/co/alt236/easycursor/EasyCursor;
...
.method public search(Ljava/lang/String;Lcom/genie_connect/android/net/container/gson/objects/TreeNodeGsonModel;)Luk/co/alt236/easycursor/EasyCursor;
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/genie_connect/android/db/access/DbProducts;->search(Ljava/lang/String;Lcom/genie_connect/android/net/container/gson/objects/TreeNodeGsonModel;I)Luk/co/alt236/easycursor/EasyCursor;
