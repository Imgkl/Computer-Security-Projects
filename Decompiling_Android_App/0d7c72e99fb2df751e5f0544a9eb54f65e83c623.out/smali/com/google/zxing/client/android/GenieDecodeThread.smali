.class final Lcom/google/zxing/client/android/GenieDecodeThread;
.super Ljava/lang/Thread;
.source "GenieDecodeThread.java"
...
# direct methods
.method constructor <init>(Lcom/google/zxing/client/android/GenieCaptureActivity;Ljava/util/Collection;Ljava/util/Map;Ljava/lang/String;Lcom/google/zxing/ResultPointCallback;)V
    .locals 4
    ...
    .line 56
    iput-object p1, p0, Lcom/google/zxing/client/android/GenieDecodeThread;->activity:Lcom/google/zxing/client/android/GenieCaptureActivity;
    ...
    iput-object v1, p0, Lcom/google/zxing/client/android/GenieDecodeThread;->handlerInitLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    iput-object v1, p0, Lcom/google/zxing/client/android/GenieDecodeThread;->hints:Ljava/util/Map;

    .line 60
    if-eqz p3, :cond_0

    .line 61
    iget-object v1, p0, Lcom/google/zxing/client/android/GenieDecodeThread;->hints:Ljava/util/Map;
    ...
    iget-object v3, p0, Lcom/google/zxing/client/android/GenieDecodeThread;->hints:Ljava/util/Map;
...
.method getHandler()Landroid/os/Handler;
    ...
    .line 89
    :try_start_0
    iget-object v0, p0, Lcom/google/zxing/client/android/GenieDecodeThread;->handlerInitLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    .line 93
    :goto_0
    iget-object v0, p0, Lcom/google/zxing/client/android/GenieDecodeThread;->handler:Landroid/os/Handler;
...
.method public run()V
    ...
    .line 99
    new-instance v0, Lcom/google/zxing/client/android/GenieDecodeHandler;

    iget-object v1, p0, Lcom/google/zxing/client/android/GenieDecodeThread;->activity:Lcom/google/zxing/client/android/GenieCaptureActivity;

    iget-object v2, p0, Lcom/google/zxing/client/android/GenieDecodeThread;->hints:Ljava/util/Map;

    invoke-direct {v0, v1, v2}, Lcom/google/zxing/client/android/GenieDecodeHandler;-><init>(Lcom/google/zxing/client/android/GenieCaptureActivity;Ljava/util/Map;)V

    iput-object v0, p0, Lcom/google/zxing/client/android/GenieDecodeThread;->handler:Landroid/os/Handler;
